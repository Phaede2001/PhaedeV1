<template>
  <div style="text-align: left">
    <h1>
      <svg
        ...
        data-v-65511fdb=""
      >
        <title data-v-65511fdb="">robot</title>
        <path
          d="M12,2A2,2 0 0,1 14,4C14,4.74 13.6,5.39 13,5.73V7H14A7,7 0 0,1 21,14H22A1,1 0 0,1 23,15V18A1,1 0 0,1 22,19H21V20A2,2 0 0,1 19,22H5A2,2 0 0,1 3,20V19H2A1,1 0 0,1 1,18V15A1,1 0 0,1 2,14H3A7,7 0 0,1 10,7H11V5.73C10.4,5.39 10,4.74 10,4A2,2 0 0,1 12,2M7.5,13A2.5,2.5 0 0,0 5,15.5A2.5,2.5 0 0,0 7.5,18A2.5,2.5 0 0,0 10,15.5A2.5,2.5 0 0,0 7.5,13M16.5,13A2.5,2.5 0 0,0 14,15.5A2.5,2.5 0 0,0 16.5,18A2.5,2.5 0 0,0 19,15.5A2.5,2.5 0 0,0 16.5,13Z"
          data-v-65511fdb=""
        ></path>
      </svg>
      OpenAI Assistant (botty)
    </h1>
    <div class="container">
      <div class="item item-center">
        <div v-if="!loading">
          <div v-if="!apikey">
            You need to provide an API Key - need help? look here
            <a
              href="https://wavemaker.co.uk/blog/getting-started-with-the-open-ai-bot/"
              target="_blank"
  ...
  L82,35.7z"
            ...
            <h3>Open Ai is doing it's thing</h3>
          </div>
        </div>
      </div>
    </div>
      ...
      fetch("https://wavemaker.co.uk/ai/index.php", {
        ...
        response.text().then((data) => {
          ...
          this.response.forEach((t) => {
            this.responsetext = this.responsetext + t.text + "\n";
          });
          this.loading = false;
          console.log(" >>>>>>>>>", data);
        });
